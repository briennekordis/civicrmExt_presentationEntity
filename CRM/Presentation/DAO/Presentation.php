 ...
 * (GenCodeChecksum:74ed26f1584d89f3f176aef222a93dc4)
 */
  ...
  public static function indices($localize = TRUE) {
    $indices = [
      'index_topic_id' => [
        ...
        'localizable' => FALSE,
        'sig' => 'civicrm_presentation::0::topic_id',
      ],
      'index_title' => [
        'name' => 'index_title',
        'field' => [
        ...
        'localizable' => FALSE,
        'sig' => 'civicrm_presentation::0::title',
      ],
      'index_date' => [
        'name' => 'index_date',
        'field' => [
        ...
        'localizable' => FALSE,
        'sig' => 'civicrm_presentation::0::date',
      ],
      'index_audience_id' => [
        'name' => 'index_audience_id',
        'field' => [
          0 => 'audience_id',
        ],
        'localizable' => FALSE,
        'sig' => 'civicrm_presentation::0::audience_id',
      ],
      'index_type_id' => [
        'name' => 'index_type_id',
        'field' => [
        ...
        'localizable' => FALSE,
        'sig' => 'civicrm_presentation::0::type_id',
      ],
    ];
