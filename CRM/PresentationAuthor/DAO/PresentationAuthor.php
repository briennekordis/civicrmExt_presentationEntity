 ...
 * (GenCodeChecksum:f6c1ea9f472e33d4f2cf92f688b57995)
 */
...
class CRM_PresentationAuthor_DAO_PresentationAuthor extends CRM_Core_DAO {
  ...
  public static function getReferenceColumns() {
    if (!isset(Civi::$statics[__CLASS__]['links'])) {
      ...
      Civi::$statics[__CLASS__]['links'][] = new CRM_Core_Reference_Basic(self::getTableName(), 'id', 'civicrm_presentation', 'id');
